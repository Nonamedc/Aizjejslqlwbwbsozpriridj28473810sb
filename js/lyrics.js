...
/* ═══════════════════════════════════════════════════════════
   ...
   _normTitle et _normArtist sont définis dans covers.js
   (chargé avant lyrics.js). Alias locaux pour clarté.
═══════════════════════════════════════════════════════════ */

// Utilise directement _normTitle et _normArtist de covers.js — pas de redéclaration
